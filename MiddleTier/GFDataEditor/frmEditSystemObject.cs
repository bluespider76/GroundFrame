        ...
        private void SaveToDB()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    MessageBox.Show(string.Format("An error has occured trying to save SystemSector {0} | ErrorID {1} : - {2}", _SystemObject.Name, Response.AuditID, Response.Exception.GetCleanMessage()), "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    this.Close();
                }
            ...
            catch (Exception Ex)
            {
                ...
                GFResponse ExceptionResonse = Audit.WriteLog(new GFResponse(AuditType.Fatal, "An unexpected error has occured at frmEditSystemObject.SaveToDB:", Ex));
